...
namespace AppointmentDrop
{
   public partial class Form1 : Form {
		...
		private void FillData() {
			...
			Appointment apt = new Appointment(start.AddHours(2), TimeSpan.FromHours(1), "normal");
			this.schedulerStorage1.Appointments.Add(apt);

			Appointment pattern = new Appointment(AppointmentType.Pattern, start.AddHours(5), TimeSpan.FromHours(1), "recurring");
